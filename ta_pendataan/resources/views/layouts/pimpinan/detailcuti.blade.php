                ...
                <div class="card-body p-6">
                  ...
                  <div class="space-y-5 divide-y divide-slate-100 dark:divide-slate-700 -mx-6">
                    ...
                    <div class="pt-4 px-6">
                      ...
                      <form action="{{ route('pimpinan.teruskancuti', $cuti->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <button type="submit" class="btn btn-primary btn-sm">Terima dan teruskan kembali ke<br> pengadministrasi umum</button>
                      </form>
                          ...
                          <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                              ...
                              <div class="p-6 space-y-4">
                                <form class="space-y-4" action="{{ route('pimpinan.tolak', $cuti->id) }}" method="post">
                                  @csrf
                                  @method('PUT')
                                  Keterangan <br>
