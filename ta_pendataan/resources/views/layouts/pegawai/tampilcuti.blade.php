      ...
      <div id="content_layout">
        ...
        <div class="card">
          <div class="card-header border-bottom">
            <a class="btn btn-outline-primary btn-sm" href="{{ route ('pegawai_cuti.tambah') }}">
                    ...
                    <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                      ...
                      <tr>
                        ...
                        @if ($tampildata->status == 'diajukan')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-info-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>
									  ...
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
										  ...
										  @elseif ($tampildata->status == 'diajukan ke pengadministrasi kepegawaian')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>												
										  @elseif ($tampildata->status == 'diajukan ke pengadministrasi umum')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>												
										  @elseif ($tampildata->status == 'diajukan ke kasubbag umum')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>				
										  @elseif ($tampildata->status == 'diajukan ke sekretaris')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>	
										  @elseif ($tampildata->status == 'diajukan ke kadis')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
									  bg-success-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>												
										  @elseif ($tampildata->status == 'ditolak')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-warning-500
									  bg-warning-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>									  
										  @elseif ($tampildata->status == 'diterima')
											<div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-success-500
									  bg-danger-500"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalhapus{{ $tampildata->id }}">
											  {{$tampildata->status}}</a>
											</div>									  								  
										  @endif					
...
<button type="button" class="btn btn-light waves-effect" data-bs-dismiss="modal">Tutup</button>
                        ...
                        <td class="table-td ">
                          <div class="flex space-x-3 rtl:space-x-reverse">
                            <a class="action-btn" href="{{ route ('pegawai_cuti.detail', $tampildata->id) }}" target="_blank">
